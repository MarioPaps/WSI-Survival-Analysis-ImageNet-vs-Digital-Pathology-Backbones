...
def train(datasets: tuple, cur: int, args: Namespace):
    ...
    if args.early_stopping:
        if args.k_fold:
            early_stopping = EarlyStopping_cindex(warmup=0, patience=args.patience, stop_epoch=args.stop_epoch, verbose = True)
        else:
            early_stopping = EarlyStopping(warmup=0, patience=args.patience, stop_epoch=args.stop_epoch, verbose = True)
    else:
        early_stopping = None
